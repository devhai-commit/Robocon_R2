...
class PickPlaceClient(Node):
    ...
    def __init__(self):
        ...
        self.presets = {
            "initial": [0.0, 0.0, 0.0, 50.0],
            "home": [0.0, 0.0, 0.0, 100.0],
            "pos1": [0.0, 0.0, 00.0, 240.0], # arm 1 len cao, mở kẹp
            "pos2": [0.0, 80.0, 0.0, -20.0],   # kep vat
            "pos3": [150.0, 80.0, -10.0, -20.0],  # nâng lên,
            "pos4": [150.0, 10.0, 90.0, -20.0],  #
            "pos5": [150.0, 0.0, 90.0, 100.0],  # tha vat
        }
